...
onready var dialogo = {"language": {"pt-br": "teste",
						"eng": {
							...
							"instructions": {
								...
								"collectedBooksLobby":["Parabéns!! Agora que você achou os livros, a biblioteca foi liberada de maneira que você poderá aprender mais sobre os temas abordados durante sua aventura, vá até uma casa no lado esquerdo do mapa, , lá você encontrará o ginásio 1 e seu mentor."],
